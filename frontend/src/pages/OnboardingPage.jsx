...
const OnboardingPage = () => {
  ...
  const { mutate: onboardingMutatation, isPending } = useMutation({
    mutationFn: completeOnboarding,
    onSuccess: () => {
      toast.success("Profile completed sucecssfully!");
  ...
  const handleSubmit = (e) => {
    ...
    onboardingMutatation(formState);
  };
  ...
  return (
    <div className="min-h-screen bg-base-100 flex items-center justify-center p-4">
      <div className="card bg-base-200 w-full max-w-3xl shadow-xl">
        {/* Moved everything inside card-body to respect padding */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="form-control">
                ...
                <select 
                  ...
                  className="select select-bordered w-full"
                  >
                    <option>Select the language you are learning</option>
                    {LANGUAGES.map((lang) => (
